...
require_once __DIR__ . '/../../includes/session_protect.php';
...
<?php if (!empty($plate['bid_price'])): ?>
  ...
  <?php if (!empty($plate['final_price'])): ?>
    <p class="d-flex align-items-center gap-1 mb-1">
      <strong>الحد:</strong> <?= intval($plate['final_price']); ?>
      <img src="../../../assets/images/Saudi_Riyal_Symbol-2.svg" alt="عملة" style="width: 15px; height: 16px; vertical-align: middle; position: relative;" >
    </p>
  <?php endif; ?>
<?php elseif (!empty($plate['final_price'])): ?>
  <p class="d-flex align-items-center gap-1 mb-1">
    <strong>الحد:</strong> <?= intval($plate['final_price']); ?>
    <img src="../../../assets/images/Saudi_Riyal_Symbol-2.svg" alt="عملة" style="width: 15px; height: 16px; vertical-align: middle; position: relative;" >
  </p>
<?php else: ?>
  <p><strong>السعر:</strong> لا يوجد سوم</p>
<?php endif; ?>
        <p>
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3" data-aos="fade-up">
        <div class="card similar-card" data-aos="zoom-in">
          ...
          <div class="card-body text-center">
            ...
            <a href="view_plate.php?id=<?= $sim['id']; ?>" class="btn btn-sm rounded-pill btn-outline-custom">
